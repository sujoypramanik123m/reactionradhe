...
PNG_BTN = [
    [
        InlineKeyboardButton(text="• sᴜᴘᴘᴏꝛᴛ •", url="t.me/supertoppers"),
    ],
    [
...
async def ping(client: Client, message: Message):
    ...
    await loda.edit_text(
        text=f"нey вαву!!\n{(await client.get_me()).mention} ʀᴇᴀᴄᴛɪᴏɴ ʙᴏᴛ ιѕ alιve  αnd worĸιng ғιne wιтн a pιng oғ\n\n**➥** `{ms}` ms\n**➲ ᴄᴘᴜ:** {CPU}\n**➲ ʀᴀᴍ:** {RAM}\n**➲ ᴅɪsᴋ:** {DISK}\n**➲ ᴜᴘᴛɪᴍᴇ »** {UP}\n\n<b>||** ➻ ʟᴏᴠᴇ ᴡɪᴛʜ ➪[Sᴜᴘᴇʀ Tᴏᴘᴘᴇʀs](https://t.me/supertoppers) **||</b>",
